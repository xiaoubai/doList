...
import '../../css/login/regist_top.css'
export default function Regist() {

  let password = useRef('password')
  let username = useRef('username')
  let passwordAgain = useRef('passwordAgain')
  const navigate = useNavigate()
  const regist = () => {

    if (username.current.value === '' || username.current.value.length < 3) {

      Toast.show({
        icon: 'fail',
        content: '账号不能为空且长度大于3',
      })

    }
    else if (password.current.value === '' || password.current.value.length < 3) {
      Toast.show({
        icon: 'fail',
        content: '密码不能为空且长度大于3',
      })
      ...
      http('post', '/users/register', { username: username.current.value, password: password.current.value })
        .then((res) => {
          if (res.code != 10002) {
            Toast.show({
              icon: 'success',
  ...
  return (
    <div>
      <div className='regist_top'>
        ...
        <div className='login_card'>
          ...
          <div className='center'>
            <div>
              ...
              <input type='text' placeholder='account' ref={username}></input>
            </div>
            ...
            <div>
              <svg t="1685950647032" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="46716" width="31" height="31"><path d="M513.525238 0C231.624846 0 3.069407 228.498134 3.069407 510.454808s228.555439 510.454808 510.454808 510.454808c281.898345 0 510.453784-228.556463 510.453784-510.454808C1023.979022 228.556463 795.42256 0 513.525238 0zM764.639462 385.394511C684.634314 493.316475 604.620979 601.369424 524.614807 709.290365c-16.693194 22.560832-55.583946 38.817074-83.120093 19.750833-57.577347-39.756469-115.089202-79.502705-172.601056-119.200846-26.301016-18.192338-40.125883-47.228651-21.809725-75.580373 15.202237-23.61586 56.704466-38.075177 83.186607-19.816325 57.511855 39.688931 127.233799 87.923492 127.233799 87.923492 67.358107-90.913593 134.658909-181.829232 202.081485-272.677333C703.074292 270.988878 808.506553 326.201363 764.639462 385.394511z" p-id="46717" fill="#61D2B4"></path></svg>
              <input type='password' placeholder='enter password again' ref={passwordAgain}></input>
            </div>
          ...
          <div className='bottom'>
            <div className='bottom_contain'>
              ...
              <div onClick={regist}>Register</div>
            </div>
          </div>
        ...
        <div className='regist_ToLogin'>
          <div className='contain'>
            <div className='left'>有账号?</div>
            <NavLink to='/login' className='right'>登录</NavLink>
          </div>
